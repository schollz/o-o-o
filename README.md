...
o-o-o (*oh-dasho-dasho*) is a synthesizer and a sequencer. it is sequenced by connecting dots.
...
each dot has an underlying random euclidean rhythm. each dot is capable of triggering a sound. the sounds that are triggered are all based on an internal FM sound engine (based on Eli Fieldsteel's [FM tutorials](https://github.com/elifieldsteel/SuperCollider-Tutorials/blob/4460e024800b6525e4223c6cce02d9643d0cfbe3/full%20video%20scripts/22_script.scd) snippets). 
